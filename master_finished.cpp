...
bool node_check;
string fname = "src/cpp_pubsub/src/info_files/nodes_lst.csv";  //path to nodes list file
...
//Globals
std::string JANUSPATH = "src/cpp_pubsub/src/lib/janus-c-3.0.5/bin/";
std::string SDMPATH = "src/cpp_pubsub/src/lib/sdmsh/";
...
void edit_nodes_lst(bool remove,bool change, string node){
    ...
    if(!remove && !change){
        ...
        const char * p = "src/cpp_pubsub/src/info_files/nodes_lst.csv";
        std::remove(p);
